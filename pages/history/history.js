...
Page({
  data: {
    ...
    motto: '给我阳光我就灿烂',
    groupons: [
      { url: '../combat/combat', text: '我发起的' },
      { url: '../combat/combat', text: '我应战的' },
      { url: '../combat/combat', text: '胜利记录' },
      { url: '../combat/combat', text: '败北记录' }
    ],
    combatList:[
    ...
    greetList: [
      { url: '../look/look', time: '1月2日', location: '体育中心', aggainst: '蜘蛛侠', state: 1 },
      { url: '../look/look', time: '1月6日', location: '广州塔', aggainst: '大笨熊', state: 1 },
      { url: '../look/look', time: '1月22日', location: '海珠广场', aggainst: '乖乖兔', state: 0 },
      { url: '../look/look', time: '1月26日', location: '创意园', aggainst: '蜘蛛侠', state: 0 }
    ],
    win: 18,
    lost: 5,
